...
local rules = {
	...
	{ rule = { instance = "telegram-desktop" }, properties = { screen = screen[3], tag = "0" } },
	{ rule = { instance = "whatsapp-nativefier-d40211" }, properties = { screen = screen[3], tag = "0" } },
	{ rule = { instance = "Insync" }, properties = { screen = screen[3], tag = "0" } },
}
